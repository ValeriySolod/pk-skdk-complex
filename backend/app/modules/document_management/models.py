...
class Document(Base):
    ...
    document_type: Mapped[str] = mapped_column(String(length=120), nullable=False)
    status: Mapped[str] = mapped_column(String(length=80), nullable=False)
...
class DocumentVersion(Base):
    ...
    version: Mapped[str] = mapped_column(String(length=80), nullable=False)
...
class DocumentCategory(Base):
    ...
    code: Mapped[str] = mapped_column(String(length=80), nullable=False, unique=True)
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class DocumentTagAssignment(Base):
    ...
    tag_id: Mapped[int] = mapped_column(ForeignKey("document_tags.id"), nullable=False)
...
class DocumentPermission(Base):
    ...
    principal_type: Mapped[str] = mapped_column(String(length=80), nullable=False)
    principal_id: Mapped[int] = mapped_column(nullable=False)
    permission: Mapped[str] = mapped_column(String(length=80), nullable=False)
