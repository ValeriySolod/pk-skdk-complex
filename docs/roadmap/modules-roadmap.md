...
| MOD-008 | File Storage | ⬜ | File upload, download, metadata, access rules; MOD-008.1 architecture skeleton created; MOD-008.2 domain model skeletons created; MOD-008.3 database migration added |
