...
| MOD-005 | User Management | ⬜ | User CRUD, role assignment, permissions management; MOD-005.1 user management architecture skeleton created; MOD-005.2 user management domain model skeletons added |
