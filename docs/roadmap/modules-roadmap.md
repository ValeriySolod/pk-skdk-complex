...
| MOD-011 | Administration | 🚧 | Application administration, reference data, maintenance tools; MOD-011.1 administration architecture skeleton created; MOD-011.2 administration domain models added; MOD-011.3 administration database migration added |
