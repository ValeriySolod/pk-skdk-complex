...
| MOD-012 | System Settings | ⬜ | Configurable application settings and defaults; MOD-012.1 system settings architecture skeleton created; MOD-012.2 system settings domain models added |
